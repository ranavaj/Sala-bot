...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "বক্স নাম কি") || (event.body.toLowerCase() == "Box name ki")) {
     return api.sendMessage("๛⃝🌻𝐆𝐑𝐄𝐄𝐍💠𝐃𝐈𝐀𝐌𝐎𝐍𝐃💠𝐒𝐈𝐍𝐆𝐄𝐑💠𝐀𝐂𝐀𝐃𝐄𝐌𝐘᛫─⃜⃜͢͢ ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Babu") || (event.body.toLowerCase() == "babu vai") || (event.body.toLowerCase() == "@বা্ঁবু্ঁ আ্ঁসো্ঁ") || (event.body.toLowerCase() == "বাবু")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:BABU ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রানা আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is  Babu❤️ তাকে সবাই রানা নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "tor boss ami")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@বা্ঁবু্ঁ আ্ঁসো্ঁ ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রানা এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Simran") || (event.body.toLowerCase() == "Riya")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Rimi") || (event.body.toLowerCase() == "Ritu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "pakhi") || (event.body.toLowerCase() == "Nila")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর Ex এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@─EX XANS➺🪼🪻🩷🪽󱢏") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-মাহমুদ-🌺 আমার বস রানা'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 [ / ] • BABU ☢️_𖣘 -𝐁𝐎𝐓 ⚠️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😅") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("️কি গো কলিজা তোমার কি আমার বস রানা মতো মন খারাপ🥺", threadID);
   };
  
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিক ওইদিক কি দেখো আমাকে দেখো এখন আমাকে কিউট বলো বাবু😍😋😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই প্রেম করবি আমার বস রানা কে একটা জিএফ দে<🥺", threadID);
   };
   
   if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("ভাই তুই এত হাসিস না হাসলে তোরে মফিজে  মত লাগে..!🌚🤣", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("ভালোবাসতে চাইলে আমার বস রানা ইনবক্সে যা😪🥱", threadID);
   };
     ...
     return api.sendMessage("আসো জান আমার চিপা গিয়ে মধু খাই..!🌚🌶️🍆⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Babu") || (event.body.toLowerCase() == "kire")) {
